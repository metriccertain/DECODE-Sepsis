...
left join stg_spo2 s1
  ...
  and CAST(STRFTIME('%s', s1.charttime) as integer) between CAST(STRFTIME('%s', bg.charttime) as integer) - 2*3600 and 
         CAST(STRFTIME('%s', bg.charttime) as integer)
...
left join stg_fio2 s2
  ...
  and CAST(STRFTIME('%s', s2.charttime) as integer) between CAST(STRFTIME('%s', bg.charttime) as integer) - 4*3600 and 
         CAST(STRFTIME('%s', bg.charttime) as integer)
