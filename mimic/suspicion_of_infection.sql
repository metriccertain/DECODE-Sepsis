...
(
  select
    ...
    , DATE(abx.starttime) AS antibiotic_date
...
(
  ...
  LEFT JOIN me me72
    ...
    (
      ...
      and ab_tbl.antibiotic_time <= DATETIME(me72.charttime, '72 HOURS')
      )
      OR
      (
      ...
      and JULIANDAY(antibiotic_date) <= JULIANDAY(me72.chartdate) + 3
      )
    )
)
, ab_then_me AS
(
  ...
  LEFT JOIN me me24
    ...
    (
      ...
      and ab_tbl.antibiotic_time >= DATETIME(me24.charttime, '-24 HOURS')
      ...
      and JULIANDAY(ab_tbl.antibiotic_date) >= JULIANDAY(me24.chartdate) - 1 
